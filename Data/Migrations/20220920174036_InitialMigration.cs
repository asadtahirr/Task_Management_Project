        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedDeveloperId = table.Column<string>(type: "text", nullable: false),
                    CreatedById = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WatchedProjectTasksId = table.Column<string>(type: "text", nullable: false),
                    WatchersId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTaskUser", x => new { x.WatchedProjectTasksId, x.WatchersId });
                    table.ForeignKey(
                        name: "FK_ProjectTaskUser_AspNetUsers_WatchersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_AssignedDeveloperId",
                table: "ProjectTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTaskUser_WatchersId",
