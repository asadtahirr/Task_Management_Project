...
{
    public partial class FixCreateBug : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_Users_AssignedDeveloperId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WatchedTasksId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    WatchersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTaskUser", x => new { x.WatchedTasksId, x.WatchersId });
                    table.ForeignKey(
                        name: "FK_ProjectTaskUser_Tasks_WatchedTasksId",
                        column: x => x.WatchedTasksId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTaskUser_Users_WatchersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_AssignedDeveloperId",
                table: "Tasks",
